...
check_contains public/book/index.html 'class="book-toolbar-frame"'
check_contains public/book/index.html 'class="book-brand-lockup"'
check_contains public/book/index.html 'class="book-toolbar-actions"'
check_contains public/book/index.html 'class="book-shell-grid"'
check_contains public/book/index.html 'class="book-main-column"'
check_contains public/book/index.html 'class="book-article-shell"'
check_contains public/book/index.html 'class="book-outline-shell"'
check_contains public/book/index.html 'class="chapter-nav-card chapter-nav-next"'
check_contains public/book/chapters/chapter-04-comparative-study-of-tax-regimes-in-selected-west-african-countries.html 'class="book-page-surface"'
...
check_contains public/book/chapters/chapter-04-comparative-study-of-tax-regimes-in-selected-west-african-countries.html 'class="book-outline-shell"'
...
check_contains theme/custom.css '--book-bg: #f8fafc;'
check_contains theme/custom.css 'font-size: 1rem;'
check_contains theme/custom.css 'background: rgba(255, 255, 255, 0.96);'
check_contains theme/custom.css 'grid-template-columns: minmax(15rem, 18rem) minmax(0, 1fr) minmax(13rem, 15rem);'
check_contains theme/custom.css 'box-shadow: 0 18px 48px rgba(15, 23, 42, 0.08);'
check_contains theme/custom.css '@media (max-width: 1180px)'
check_contains theme/custom.css '.book-outline-shell {'
check_contains theme/custom.css '@media (max-width: 900px)'
check_contains theme/custom.css '.book-toolbar-frame {'

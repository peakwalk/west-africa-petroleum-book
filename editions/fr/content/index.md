...
Start with the [Foreword](chapters/foreword.md), move through the [General Introduction](chapters/general-introduction.md), or go directly to [Chapter 1](chapters/chapter-01-value-chain-of-the-hydrocarbon-sector.md).

## Source Note

This edition was generated from the edited Word manuscript and normalized for web reading with mdBook. Figures extracted from the manuscript are stored in this edition's `images/` directory and referenced from chapter files using relative paths.

...
![Figure 010](../images/figure-010.webp)
...
<section class="formula-group formula-group--prospect" data-equation-label="2.1" aria-label="Formule du prospect">
  <div class="book-formula" role="img" aria-label="P prospect égale P roche mère fois P réservoir fois P piège">
    <span class="book-formula-line" aria-hidden="true">P(prospect) = P(roche mère) x P(réservoir) x P(piège)</span>
  </div>

  <div class="formula-where formula-where--grid formula-where--prospect" aria-label="Définitions de la formule du prospect">
    <div class="formula-spec-grid formula-spec-grid--two">
      <article class="formula-spec-item">
        <p class="formula-spec-copy">
          <!-- parity-ignore:start -->
          <span class="formula-where-term">P(piège):</span>
          <!-- parity-ignore:end -->
      ...
      <article class="formula-spec-item">
        <p class="formula-spec-copy">
          <!-- parity-ignore:start -->
          <span class="formula-where-term">P(réservoir):</span>
          <!-- parity-ignore:end -->
      ...
      <article class="formula-spec-item">
        <p class="formula-spec-copy">
          <!-- parity-ignore:start -->
          <span class="formula-where-term">P(roche mère):</span>
          <!-- parity-ignore:end -->
...
<section class="formula-group formula-group--volumetric" data-equation-label="2.2" aria-label="Formules d’évaluation volumétrique">
  <div class="book-formula" role="img" aria-label="VHcP égale GRV fois N sur G fois phi fois Shc fois un sur FVF">
    <span class="book-formula-line" aria-hidden="true">VHcP = GRV x N/G x Ø x Shc x 1/FVF</span>
  </div>

  <div class="formula-where formula-where--grid formula-where--volumetric" aria-label="Définitions de l’évaluation volumétrique">
    <p class="formula-where-label">Avec</p>
    <div class="formula-spec-grid formula-spec-grid--two formula-spec-grid--volumetric">
      <article class="formula-spec-item">
        <p class="formula-spec-copy"><span class="formula-where-term">GRV= Gross Rock Volume (Volume Brut de la Roche réservoir) :</span> il est déterminé en tenant compte de la forme géométrique du réservoir et de son épaisseur</p>
        <div class="book-formula book-formula--local" role="img" aria-label="GRV égale somme des surfaces du gisement multipliée par l’épaisseur du gisement">
          <span class="book-formula-line" aria-hidden="true">GRV = ∑Surface du gisement x Epaisseur du gisement</span>
        </div>
      </article>
      <article class="formula-spec-item">
        <p class="formula-spec-copy"><span class="formula-where-term">N/G :</span> C’est le rapport entre l’épaisseur net du réservoir et l’épaisseur brut du réservoir. Il faut noter que l’épaisseur du gisement n’a pas souvent une lithologie uniforme. Il est souvent intercalé par des couches d’argile imperméable.</p>
      </article>
      <article class="formula-spec-item">
        <p class="formula-spec-copy"><span class="formula-where-term">Ø (Phi) =</span> Porosité du réservoir qui est estimée à partir des diagraphies électriques, des mesures sur les carottes et des connaissances provenant des formations similaires. Elle se détermine comme suit :</p>
        <div class="book-formula book-formula--local" role="img" aria-label="La porosité phi égale le volume des pores sur le volume du réservoir">
          <span class="book-formula-line" aria-hidden="true">Porosité (Ø) = Volume des pores (Vv)/ Volume du Réservoir (V)</span>
        </div>
      </article>
      <article class="formula-spec-item">
        <p class="formula-spec-copy"><span class="formula-where-term">Shc =</span> Saturation en hydrocarbures déterminé en connaissant la saturation en eau Sw. Il est généralement calculé à partir des digraphies de puits dans la zone de porosité effective.</p>
        <div class="book-formula book-formula--local" role="img" aria-label="Shc égale un moins Sw">
          <span class="book-formula-line" aria-hidden="true">Shc = 1-Sw</span>
        </div>
      </article>
      <article class="formula-spec-item">
        <p class="formula-spec-copy"><span class="formula-where-term">FVF :</span> C’est le Facteur Volumétrique de Formation. Elle exprime le changement de volume de l’huile du réservoir à la surface dans les conditions standard de pression et de température (pression : 1 atm et température : 15° Celsius). FVF de l’huile est Bo et pour le gaz est Bg.</p>
        <div class="book-formula book-formula--local" role="img" aria-label="FVF égale volume réservoir sur volume à la surface">
          <span class="book-formula-line" aria-hidden="true">FVF = Volume réservoir/Volume à la surface</span>
        </div>
      </article>
  ...
  <div class="formula-derivation formula-derivation--volumetric" aria-label="Dérivation FVF pour le pétrole et le gaz">
    <div class="formula-case-grid">
      <section class="formula-case" aria-label="Cas du pétrole">
        <p class="formula-case-title">Pour l’huile</p>
        <div class="formula-case-stack">
          <div class="book-formula book-formula--secondary" role="img" aria-label="FVF égale Bo et Shc égale So pour la saturation en huile">
            <span class="book-formula-line" aria-hidden="true">FVF = Bo et Shc = So (saturation en huile)</span>
          </div>
          <p class="formula-case-connector">Ainsi,</p>
          <!-- parity-ignore:start -->
          <div class="book-formula book-formula--secondary book-formula--result" role="img" aria-label="STIIOP égale GRV fois N sur G fois phi fois So fois un sur Bo">
            <span class="book-formula-line" aria-hidden="true">STIIOP = GRV x N/G x Ø x So x 1/Bo</span>
          </div>
          <div class="book-formula book-formula--secondary" role="img" aria-label="Le gaz associé en place égale STOIIP multiplié par GOR">
            <span class="book-formula-line" aria-hidden="true">Gaz associé en place = STOIIP x GOR</span>
          </div>
          <!-- parity-ignore:end -->
          <p hidden>STIIOP = GRV x N/G x Ø x So x 1/BoGaz associé en place = STOIIP x GOR</p>
        </div>
      </section>
      <section class="formula-case" aria-label="Cas du gaz">
        <p class="formula-case-title">Pour le gaz</p>
        <div class="formula-case-stack">
          <div class="book-formula book-formula--secondary" role="img" aria-label="FVF égale Bg et Shc égale Sg pour la saturation en gaz">
            <span class="book-formula-line" aria-hidden="true">FVF = Bg et Shc = Sg (Saturation en gaz)</span>
          </div>
          <p class="formula-case-connector">Ainsi,</p>
          <div class="book-formula book-formula--secondary book-formula--result" role="img" aria-label="GIIP égale GRV fois N sur G fois phi fois Sg fois un sur Bg">
            <span class="book-formula-line" aria-hidden="true">GIIP = GRV x N/G x Ø x Sg x 1/Bg</span>
          </div>
          <div class="book-formula book-formula--secondary" role="img" aria-label="Le condensat en place égale GIIP multiplié par CGR">
            <span class="book-formula-line" aria-hidden="true">Condensat en place = GIIP x CGR</span>
          </div>
        </div>
      </section>
    </div>
    <div class="formula-case-note">
      <p class="formula-where-label">avec:</p>
      <p class="formula-note"><span class="formula-note-term">GOR :</span> appelé Gaz-Oil Ratio est le rapport volume de gaz sur volume d’huile produite</p>
      <p class="formula-note"><span class="formula-note-term">CGR :</span> appelé Condensate-Gaz Ratio est le rapport volume de condensat sur le volume de gaz produit</p>
    </div>
  </div>
</section>
...
![Figure 018](../images/figure-018.webp)
...
<table>
<caption><p>Tableau 4: Calcul des pertes financières qu’engendreraient une erreur de mesure de 0,4 %</p></caption>
<colgroup>
<col style="width: 13%" />
<col style="width: 18%" />
<col style="width: 18%" />
...
<thead>
<tr>
  <th rowspan="2" style="text-align: left;"><p>Pays</p></th>
  <th rowspan="2" style="text-align: left;"><p>Production journalière (bl/j)</p></th>
  <th rowspan="2" style="text-align: left;"><p>Erreur de mesure/comptage (%)</p></th>
  <th rowspan="2" style="text-align: left;"><p>Prix du baril ($US)</p></th>
  <th colspan="2" style="text-align: left;"><p>Perte financière ($US)</p></th>
</tr>
<tr>
  <th style="text-align: left;"><p>journalière</p></th>
  <th style="text-align: left;"><p>annuelle</p></th>
</tr>
</thead>
<tbody>
<tr>

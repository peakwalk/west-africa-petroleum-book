...
## Overview
This plugin packages the repo-specific workflow for the Africa Book project. Treat `src/chapters`, `theme`, `scripts`, and `src/images` as source. Treat `public/` as generated output.
...
4. After figure or reference changes, rebuild `src/images/figure-manifest.json` with `python3 scripts/build_docx_figure_manifest.py`.
